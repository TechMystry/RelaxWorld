...
import { Calendar, Star, Search, X } from 'lucide-react';
...
Day 9oran: Arrival Pune. Tour ends in happy memories.`,
...
export default function AllDestinations() {
  ...
  const getProgressWidth = (duration: string): string => {
  ...
  return (
    <section className="py-16 bg-gray-50 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4">
        ...
        >
          <h2 className="text-3xl font-bold text-gray-800">All Tour Packages</h2>
          <Link
            href="/"
          ...
          >
            ...
            >
              <button
                ...
                className="absolute top-4 right-4 text-gray-700 hover:text-red-500 text-3xl font-bold transition-all duration-200 hover:scale-110 focus:outline-none focus:ring-2 focus:ring-red-500"
              >
                <X className="w-8 h-8" />
              </button>
              ...
              <div className="flex flex-col md:flex-row gap-6">
                ...
                <div className="md:w-1/2 flex flex-col">
                  ...
                  <div className="flex-1 max-h-[50vh] overflow-y-auto no-scrollbar pr-2">
                    {selectedPackage.details
                      ...
                      .map((line, idx) => {
                        ...
                        if (dayMatch) {
                          ...
                          const content = line.replace(/Day \d+:\s*/i, '').trim();
                          return (
                            <motion.div
                              key={idx}
